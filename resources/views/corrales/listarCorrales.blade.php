...
@section('contenedor')
  ...
  <div id="formulario"  class="row">
    ...
    <div class="form row" >
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <!-- Titulo central -->
        <h3 id="Encabezado_del_formulario">Corrales</h3>
      </div>
    </div>
    <br>
...
<div class="row">
  <div class="col-md-12">
    <div class="modal fade" id="mod_editar_corral" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel">
      <div class="modal-dialog modal-lg">
        <div class="modal-content col-md-10 col-md-offset-2">
          {!!Form::open(['id'=>'corral-actualizar'])!!}
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title" id="myModalLabel"><i class="fa fa-user" aria-hidden="true"></i> Información del corral</h4>
          </div>
          <div class="modal-body">
            <div class="row">
              <div class="col-md-12"  style="padding-bottom: 10px">
                {!!form::label('Código corral')!!}
            ...
            <div class="row">
              <div class="col-md-12"  style="padding-bottom: 10px">
                {!!form::label('Tipo')!!}
                {!!form::select('tipo',['0'=>'Enfermos','1'=>'Terneros','2'=>'Produccion','3'=>'Parto'],null,['class'=>'form-control','id'=>'tipo'])!!}
              </div>
            </div>
            <div class="row">
              <div class="col-md-12"  style="padding-bottom: 10px">
            ...
            <div class="row">
              <div class="col-md-12"  style="padding-bottom: 10px">
                ...
                {!!form::input('text','capaci',null,['class'=>'form-control','id'=>'capaci'])!!}
              </div>
            </div>
            {!! Form::close() !!}
...
@section('scripts')
  ...
  corral.tabla_corrales();
  validacion_corral.validar_actualizar_corral();
  </script>
@endsection
